...
class Epoche {
 ...
 public:
  ...
  void markNodeForDeletion(const std::function<void()>& callback,
...
class EpocheGuard {
 ...
 public:
  inline EpocheGuard(ThreadInfo& threadEpocheInfo)
...
inline void DeletionList::add(const std::function<void()>& callback,
